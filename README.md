...
- **partdb-grpc**: Public gRPC protobuf definitions and generated classes for KV and cluster APIs
- **partdb-transport-grpc**: gRPC server bootstrap and Raft transport adapters on top of the node runtime
